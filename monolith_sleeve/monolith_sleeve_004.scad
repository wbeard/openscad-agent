// Monolith Sleeve - friction-fit architectural shell for the M4 Mac mini - v004
...
//
// v004 over v003: skill-conformance pass only - adaptive curve quality
// ($fa=1/$fs=0.4 instead of a global $fn=64); no dimensional changes.
//
...
$fa = 1; $fs = 0.4;   // adaptive curve quality (do not set a global $fn)
